...
const { extractAndSavePurchasedItems } = require("./services/purchaseHistoryService.js");
...
app.get('/api/predictionModel', async(req,res)=>{
	await extractAndSavePurchasedItems();
	return res.status(200).send('Purchase Data successfully processed')
});
